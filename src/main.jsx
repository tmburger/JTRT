...
function Button({ children, className = "", variant = "solid", type = "button", ...props }) {
  ...
  return (
    <button
      type={type}
      className={`inline-flex items-center justify-center rounded-full px-7 py-3 text-sm font-semibold transition focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 ${variants[variant]} ${className}`}
      {...props}
    >
      {children}
    </button>
...
<div className="flex h-[64px] w-auto items-center justify-center overflow-hidden">
  <img src={logoUrl} alt="JTRT Solutions" className="h-[72px] w-auto object-contain" />
</div>
<div className="hidden sm:block">
  <div className="text-base font-semibold text-slate-900">JTRT Solutions</div>
  <div className="text-[10px] font-medium uppercase tracking-[0.16em] text-slate-500">IT Consulting</div>
</div>
        </a>
